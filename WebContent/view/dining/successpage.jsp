...
function goHome(){
	InitLayer();
	var url = "<c:url value='/dining/listFirmFromCity.do?pk_group=${pk_group}&openid=${openid}' />";
...
<div data-role="page" data-theme="d"><!--页面层容器-->
	<div data-role="content" style="margin-top:0;list-style:none;padding:0;"><!--页面主体-->
		...
		<div class="bottonDiv">
			<form id="detailForm" data-ajax="false" action="<c:url value='/bookDesk/orderDetail.do' />">
				...
				<p>
					<input type="button" value="查看订单详情" data-role='none' data-ajax="false" onclick="javaScript:goOrders();"> 
				</p>
				<p>
					<input type="button" value="返回首页" data-role='none' data-ajax="false" onclick="javaScript:goHome('${pk_group}');">
				</p>
			</form>
		</div><!-- bottonDiv -->
		<!--  
		<div class="footer" data-role="footer" data-position="inline" data-fullscreen="true">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
			<tr>
				<td id="ui-a"><a href="<c:url value='/bookDesk/listFirm.do?pk_group=${pk_group}' />" data-ajax="false"><img src="<c:url value='/image/wechat/back.png'/>"/>&nbsp;</a></td>
			</tr>
		</table>
		</div>
		-->

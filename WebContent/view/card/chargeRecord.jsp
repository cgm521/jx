...
<body>
	...
	<div class="card_top">充值记录</div>
	<div class="main" style="width:90%;margin:0 auto;">
			<table>
				<c:forEach var="chargRecord" items="${listChargeRecord }">
					<tr style="border-bottom: solid #DCD7D6 1px;">
						<td>
							<table>
								<tr style="font-size:18px;font-family:Verdana, '楷体', Arial,Sans;">
									<td style="width:35%;">充值金额：</td>
									<td><span style="color:red;">${chargRecord.rmbamt }</span>元</td>
								</tr>
								<tr style="font-size:18px;font-family:Verdana, '楷体', Arial,Sans;">
									<td>充值时间：</td>
									<td>${chargRecord.tim }</td>
								</tr>
							</table>
						</td>
					</tr>

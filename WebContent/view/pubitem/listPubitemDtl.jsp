...
<html>
	...
	<body>
		<div>
			<div class="mainLeft" id="mainLeft" style="width:30%;height:100%;margin:0 0 0 -2%;float:left;">
			...
			<form action="<%=path %>/pubitem/sessionOrder.do" method="post" id="queryForm">
				...
				<input type="button" id="myOrder1" class="myOrder1" data-role="none" value="">
			</form>
		</div>
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#mainLeft").addClass("mainLeft");
				$("#mainLeft").addClass("mainLeft ul li");
				$("#mainRight").addClass("mainRight");
				$("#myOrder1").addClass("myOrder1");
